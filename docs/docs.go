...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_kirillat6_go-rest_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Задачи успешно найдены",
                        "schema": {
                            "type": "array",
                            "items": {
    ...
    "definitions": {
        "github_com_kirillat6_go-rest_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "github_com_kirillat6_go-rest_internal_core_transport_http_types.Nullable-string": {
            "type": "object",
            "properties": {
                "set": {
                    "type": "boolean"
        ...
        "internal_features_users_transport_http.PatchUserRequest": {
            ...
            "properties": {
                "full_name": {
                    "$ref": "#/definitions/github_com_kirillat6_go-rest_internal_core_transport_http_types.Nullable-string"
                },
                "phone_number": {
                    "$ref": "#/definitions/github_com_kirillat6_go-rest_internal_core_transport_http_types.Nullable-string"
                }
