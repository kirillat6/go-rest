...
import (
	...
	core_http_types "github.com/kirillat6/go-rest/internal/core/transport/http/types"
	core_http_utils "github.com/kirillat6/go-rest/internal/core/transport/http/utils"
)
...
func (r *PatchUserRequest) Validate() error {
	...
	if r.PhoneNumber.Set {
		if r.PhoneNumber.Value != nil {
			...
			if phoneNumberLen > 15 || phoneNumberLen < 10 {
